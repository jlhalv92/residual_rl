...
from src.networks.networks import CriticNetwork, ActorNetwork, QRESLIMNoMagic
...
def experiment(alg, n_epochs, n_steps, n_episodes_test, run_id):
    ...
    critic_params = dict(network=QRESLIMNoMagic,
    ...
    agent.save("checkpoint/one_net_residual_run_{}".format(run_id))
    wandb.finish()
