...
def experiment(alg, n_epochs, n_steps, n_episodes_test, run_id, target_speed, residuals, reference_epoch, curriculum_id, stop_log):
    ...
    if log:
        wandb.init(
            ...
            name="residual_resnet_curriculum_np"
        )
    ...
    agent.save("checkpoint/walker_run_curriculum_3_steps_np_{}_{}".format(curriculum_id, run_id))
    if stop_log:
        wandb.finish()
...
if __name__ == '__main__':
    ...
    for i in range(3):
        ...
        epochs = [10, 10, 20]
        ref_epochs = [0, 10, 20]
        rhos = ["checkpoint/walker_run_curriculum_3_steps_np_{}_{}".format(j, i) for j in range(2)]
