...
def experiment(alg, n_epochs, n_steps, n_episodes_test, run_id, target_speed, residuals, reference_epoch, curriculum_id, stop_log):
    ...
    if log:
        wandb.init(
            ...
            name="residual_resnet_curriculum_4_steps_kl"
        )
    ...
    agent.save("checkpoint/walker_run_curriculum_4_steps_kl_{}_{}".format(curriculum_id, run_id))
    if stop_log:
        wandb.finish()
...
if __name__ == '__main__':
    ...
    for i in range(5):
        ...
        rhos = ["checkpoint/walker_run_curriculum_4_steps_kl_{}_{}".format(j, i) for j in range(2)]
